...
![](20230215_175410.jpg) From figure 15-1 we can see that intracellular signalling starts with a receptor protein that recieves a signal from a extracellular signal molecule and end with an alteration to the cell catalyzed by a effector protein with intracellular signaling proteins acting as a mediating step.
...
![](20230215_201904.jpg) The same ligand and nuclear receptor can cause different effects in different cell types because each cell has a combination of ohter cell-type-specific gene regulatory proteins that collaborate with the active receptor.
...
Adapter Protein vs Scaffold Proteins (think lego)

- Adapter: 

more ordered structure

Have domains that can bind to a variety of proteins (think puzzle piece)

- Scaffold

less ordered structure

Have domains that bind to specific proteins 
